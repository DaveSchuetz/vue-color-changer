...
//Vue.component is used to make a child/branch off the Vue instance where the props can be affected
Vue.component("swatch", {
	...
	template: `
		<div class="grid-item">
			...
			<div class="grid-cell--bottom" :style="corrected_color(swatch)">
    ...
    methods: {
        corrected_color: function (swatch) {
            return {
                color: swatch.color == '#ffffff' ? '#000000' : swatch.color
            }
        }
    }
})
